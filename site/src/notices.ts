...
export const NOTICES: Notice[] = [
  {
    id: '2026-09-01-board',
    date: '2026-09-01',
    title: '入口を「3凸ボード」にしました',
    items: [
      { tag: '新機能', text: '<b>3凸ボード</b>: 枠ごとにボスを選ぶと、そのボスに有利なコードの編成 (属性別編成タブの案) が入ります。<b>同じニケは3凸のうち1度だけ</b>なので、枠をまたいだ被りをその場で出し、「外す / 譲る」どちらが得かを計算して解きます。「被りなしで最大の3凸を探す」で全候補から合計最大の組み合わせを入れます。' },
      { tag: '改善', text: 'ページの顔をユニオンレイド向けに軽くしました。計算機は「計算機」タブ (詳細計算) にそのまま残っています。更新履歴は自動では開かず、上の「更新履歴」から見られます。' },
    ],
  },
  {
    id: '2026-09-01-beta',
